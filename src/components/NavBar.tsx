...
const NavBar = () => (
  <header className="relative">
      ...
      <div>
        <div className="hidden text-white md:block">
          <div className="flex gap-4">
            <Link className="pb-1" href="./">About</Link>
            <Link className="pb-1" href="./">Careers</Link>
            <Link className="pb-1" href="./">Events</Link>
            <Link className="pb-1" href="./">Products</Link>
            <Link className="pb-1" href="./">Support</Link>
          </div>
        ...
        <div className="md:hidden">
          <div className="drawer drawer-end z-[20]">
            ...
            <div className="drawer-content">
              {/* Page content here */}
              <label htmlFor="nav-drawer" className="btn btn-primary drawer-button border-0 text-3xl text-white"><GiHamburgerMenu /></label>
            </div>
            <div className="drawer-side">
              <label htmlFor="nav-drawer" className="drawer-overlay" />

              <ul className="menu min-h-full w-full bg-black p-4 font-secondary text-3xl uppercase text-white [&_li]:w-fit [&_li]:py-2">
                {/* Sidebar content here */}
                <div className="flex justify-end pb-32 pr-5 pt-8 text-4xl">
    ...
    <div className="absolute inset-x-[5%] top-1/3 w-[90%] md:inset-x-[10%] md:w-2/4">
      <p className="border-2 border-white p-6 pr-20 font-secondary text-4xl uppercase text-white lg:text-6xl">Immersive experiences that deliver</p>
    </div>
  </header>
